...
function updateWhitepaperLink(lang) {
  const pdfMap = {
    zh: "KTM Exchange-Whitepaper-zh.pdf",
    en: "KTM Exchange-Whitepaper-en.pdf",
    br: "KTM Exchange-Whitepaper-br.pdf",
    kr: "KTM Exchange-Whitepaper-kr.pdf",
    jp: "KTM Exchange-Whitepaper-jp.pdf",
    es: "KTM Exchange-Whitepaper-es.pdf"
  };

  const link = document.getElementById("whitepaper-link");
  if (link) {
    link.href = "http://www.KTM Exchange.cn/static/files/" + pdfMap[lang] || pdfMap["br"];
  }
}